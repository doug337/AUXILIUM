...
<html>
    ...
    <fieldset>
        ...
        <div class="campo">
            ...
            <input type="email" id="email" name="email" style="width: 62em" value="" >
		</div>
		<div class="campo">	
			<label for="senha">Senha*</label>
            <input type="password" id="senha" name="senha" style="width: 30em" value="" >
		...
		<fieldset class="grupo">
            <div class="campo">
                ...
                <input type="text"  name="cidade" style="width:20em" value="" >
            </div>
            <div class="campo">
		...
		<fieldset>
			<div class="campo">
                ...
                <input type="text" id="escola" name="escola" style="width:"10" >
            </div>
			</fieldset>
