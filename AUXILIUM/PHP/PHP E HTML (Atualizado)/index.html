	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>Esse é um site de doações para ONGs</p>
				<ul class="actions">
					<li>
						<a href="cadastro.html" class="button big">Cadastre-se</a>
					</li>
				</ul>
			</section>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 special">
				<div class="container">
					<header class="major">
						<h2>Ajude com amor</h2>
						<p>Voce poderá fazer doações para ajudar ONGs, desta forma ajudará ao proxímo</p>
					</header>
					...
					<section class="links">
						<div class="row">
							<section class="3u 6u(medium) 12u$(small)">
								<h3>Respeito</h3>
								<ul class="unstyled">
									<li><a >Tenha respeito pelo próximo, esse site é para ajudar pessoas </a></li>
